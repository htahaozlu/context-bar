...
7. ⏳ **B2** — `ratatui` + `crossterm` `context-bar live` 5h-block burn dashboard (burn rate, % of limit, ETA-to-limit, projected total). The crown-jewel cross-platform feature; reuses the engine. NEXT.
